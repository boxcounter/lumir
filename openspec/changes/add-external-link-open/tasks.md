...
- [x] 5.5 全量真机回归 **20/20 PASS（221 断言，约 7 分钟）**，证据归档 `test-results/acceptance/2026-09-16/`（worktree 本地，git 外）；`12-links` 单场景 22 断言全 PASS，含 title↗︎ 在真实 WKWebView 上屏、⌘⏎ 走通 opener（诊断日志 `link_open` `scheme=https` `outcome=opened`，3 条、无 URL 原文）
