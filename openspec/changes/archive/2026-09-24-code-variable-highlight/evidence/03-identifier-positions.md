...
本文件支撑 [code-variable-highlight](../proposal.md) 的判据设计与 [code-outline](../../2026-09-24-code-outline/proposal.md) 的条目口径。同内容各持一份副本。（归档时改准：`code-outline` 那条原写 `../proposal.md`，落到了本 change 自己的 proposal 上——标签与目标不一致。）
