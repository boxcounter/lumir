...
> **2026-09-26 修订（Alex，M236 同批）**：D1 默认值 680 → **760**、D2 区间 [680, 1200] →
> **[760, 1200]**（默认值仍即下限）。原话「采纳你的建议档：默认 760、区间[760,1200]。我没有别的
> 意见了，你可以动手了」。下面这段 2026-09-25 的逐字记录与论证保留为历史档，**现役值以本行为准**；
> 修订动因与影响见 `design.md` 的「§0 修订记录」。
